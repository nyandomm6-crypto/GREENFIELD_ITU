...
('Compost (1kg)', 'CMP-001', 3000.00, 1),
('Compost (5kg)', 'CMP-002', 13500.00, 1),
('Compost (10kg)', 'CMP-003', 27000.00, 1),
('Compost (50kg)', 'CMP-004', 121500.00, 1),
('Terre melangée', 'ENG-001', 8000.00, 2),
('Pin', 'PLTR-001', 1700.00, 3),
('Ficus', 'PLTR-002', 1700.00, 3),
('Monstera', 'PLTR-003', 1700.00, 3),
('Succulente', 'PLTR-004', 1700.00, 3),
('Bambou', 'PLTR-005', 1700.00, 3),
('Orangier', 'PLTP-001', 2950.00, 4),
('Tomate', 'PLTP-002', 2950.00, 4),
('Basilic', 'PLTP-003', 2950.00, 4),
('Menthe', 'PLTP-004', 2950.00, 4),
('Persil', 'PLTP-005', 2950.00, 4),
('Rose', 'PLTF-001', 15000.00, 5),
('Tulipe', 'PLTF-002', 35000.00, 5),
('Lys', 'PLTF-003', 25000.00, 5),
('Orchidée', 'PLTF-004', 12000.00, 5),
('Géranium', 'PLTF-005', 18000.00, 5);

-- Categorie 1 : Compost (CMP)
UPDATE Produit SET poids_moyenne_unitaire = 1.0 WHERE id = 1; -- Compost (1kg)
UPDATE Produit SET poids_moyenne_unitaire = 5.0 WHERE id = 2; -- Compost (5kg)
UPDATE Produit SET poids_moyenne_unitaire = 10.0 WHERE id = 3; -- Compost (10kg)
UPDATE Produit SET poids_moyenne_unitaire = 50.0 WHERE id = 4; -- Compost (50kg)
-- Categorie 2 : Terre (ENG)
UPDATE Produit SET poids_moyenne_unitaire = 15.0 WHERE id = 5; -- Terre melangée
-- Categorie 3 : Plantes de Terre / Décoratives (PLTR)
UPDATE Produit SET poids_moyenne_unitaire = 2.5 WHERE id = 6;  -- Pin (jeune plant en pot)
UPDATE Produit SET poids_moyenne_unitaire = 1.2 WHERE id = 7;  -- Ficus (taille moyenne de bureau)
UPDATE Produit SET poids_moyenne_unitaire = 1.8 WHERE id = 8;  -- Monstera (feuillage et pot moyen)
UPDATE Produit SET poids_moyenne_unitaire = 0.3 WHERE id = 9;  -- Succulente (très léger, petit godet)
UPDATE Produit SET poids_moyenne_unitaire = 2.0 WHERE id = 10; -- Bambou (motte plus dense)

-- Categorie 4 : Plantes Potagères / Aromatiques (PLTP)
UPDATE Produit SET poids_moyenne_unitaire = 1.5 WHERE id = 11; -- Orangier (jeune arbuste greffé)
UPDATE Produit SET poids_moyenne_unitaire = 0.4 WHERE id = 12; -- Tomate (jeune pousse en godet)
UPDATE Produit SET poids_moyenne_unitaire = 0.2 WHERE id = 13; -- Basilic (petit pot aromatique)
UPDATE Produit SET poids_moyenne_unitaire = 0.2 WHERE id = 14; -- Menthe (petit pot aromatique)
UPDATE Produit SET poids_moyenne_unitaire = 0.2 WHERE id = 15; -- Persil (petit pot aromatique)

-- Categorie 5 : Plantes à Fleurs / Ornementales (PLTF)
UPDATE Produit SET poids_moyenne_unitaire = 1.0 WHERE id = 16; -- Rose (rosier en pot de culture)
UPDATE Produit SET poids_moyenne_unitaire = 0.5 WHERE id = 17; -- Tulipe (pot de bulbes)
UPDATE Produit SET poids_moyenne_unitaire = 0.8 WHERE id = 18; -- Lys (pot moyen)
UPDATE Produit SET poids_moyenne_unitaire = 0.6 WHERE id = 19; -- Orchidée (substrat d'écorce léger)
UPDATE Produit SET poids_moyenne_unitaire = 0.7 WHERE id = 20; -- Géranium (pot de balconnière classique)
...
INSERT INTO fraisLivraison (idprovince, poidsreference, montant) VALUES
(1, 0.0, 5000.00), -- Antananarivo, supérieur à 0kg
...
(6, 5000.0, 4000000.00); -- Toliara, supérieur à 5000kg
