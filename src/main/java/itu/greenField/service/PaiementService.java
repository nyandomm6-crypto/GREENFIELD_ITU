...
public class PaiementService {
    ...
    public PaiementService(PaiementRepository paiementRepository,
            PaiementFilleRepository paiementFilleRepository,
        ...
        this.paiementFilleRepository = paiementFilleRepository;
    ...
    public BigDecimal getMontantTotalCommande(Commandes commande) {
        ...
        BigDecimal fraisLivraison = commande.getFraisLivraison() == null ? BigDecimal.ZERO : commande.getFraisLivraison();
    ...
    public boolean aUnPaiementEnEspece(Paiement paiement) {
        return paiement != null
                && !paiementFilleRepository.findByPaiementIdAndTypePayement(paiement.getId(), TypePayement.Espece).isEmpty();
    }
    ...
    private void verifierMontantExact(BigDecimal montantSaisi, BigDecimal montantAttendu, String message) throws Exception {
